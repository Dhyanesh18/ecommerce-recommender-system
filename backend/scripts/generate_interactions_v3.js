...
const CLICK_PROB    = 0.68;
const CART_PROB     = 0.45;
const PURCHASE_PROB = 0.35;
    ...
    try {
        ...
        for (const user of users) {
            ...
            for (let s = 0; s < sessions; s++) {
                ...
                const maxPurchases = Math.random() < 0.15 ? 2 : 1;
                let purchased = 0;
                ...
                for (const c of shuffled) {
                    ...
                    if (product.price > 1000 && Math.random() > 0.3) continue;
